...
export function ExpandableCardDemo() {
    ...
    const themedCards = cards.map((card) => ({
        ...card,
        src: resolvedTheme === 'dark' ? card.imageDark : card.imageLight
    }));
                    ...
                    <div className='fixed inset-0 z-[100] grid place-items-center'>
                        <motion.div
                            ...
                            <motion.button
                                ...
                                className='absolute top-3 right-5 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-md lg:hidden dark:bg-neutral-800'
                            ...
                            <motion.div layoutId={`image-${active.title}-${id}`}>
                                <img
                                    width={200}
                                    height={200}
                                    src={resolvedTheme === 'dark' ? active.imageDark : active.imageLight}
                                    alt={active.title}
                                    className='h-80 w-full rounded-4xl object-contain object-top lg:h-80'
                                />
                            </motion.div>
                            <div>
...
const cards = [
    {
        description: 'India',
        title: 'A. Deep Verma',
        imageLight: '/fav-black.png',
        imageDark: '/fav-white.png',
        ctaText: 'About me',
        content: () => (
            <p>
