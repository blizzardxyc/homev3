...
const Link000 = ({ children, href, className }: { children: React.ReactNode; href: string; className?: string }) => {
    return (
        <Link
            href={href}
            className={cn(
...
const Link001 = ({ children, href, className }: { children: React.ReactNode; href: string; className?: string }) => {
    return (
        <a
            href={href}
            rel='noreferrer'
...
const Link002 = ({ children, href, className }: { children: React.ReactNode; href: string; className?: string }) => {
    return (
        <a
            href={href}
            className={cn(
...
const Link003 = ({ children, href, className }: { children: React.ReactNode; href: string; className?: string }) => {
    return (
        <a
            href={href}
            className={cn(
...
const Link004 = ({ children, href, className }: { children: React.ReactNode; href: string; className?: string }) => {
    return (
        <a
            href={href}
            className={cn(
            ...
            {children}
            <svg
                className='z-0 mt-[0em] ml-[0.6em] size-[0.55em] translate-y-1 opacity-0 transition-all duration-300 [motion-reduce:transition-none] group-hover:translate-y-0 group-hover:rotate-45 group-hover:opacity-100 motion-reduce:transition-none'
                fill='none'
                viewBox='0 0 10 10'
                xmlns='http://www.w3.org/2000/svg'
                aria-hidden='true'>
...
const Link005 = ({ children, href, className }: { children: React.ReactNode; href: string; className?: string }) => {
    return (
        <a
            href={href}
            className={cn(
